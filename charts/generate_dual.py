...
def get_tolerance_chart_specs() -> list[ChartSpec]:
    ...
    return [
        ...
        ChartSpec(
            ...
            y_label="People",
            y_format="thousands",
            options={"x_sort_order": ["NSDAP Voters\n(1933)", "Convicted\n(All Courts)"]},
        ),
        ChartSpec(
            ...
            y="deaths",
            x_label="",
            y_label="Estimated Deaths (Millions)",
            y_format="thousands",
            color="type",
        ...
        ChartSpec(
            ...
            y="intolerance_pct",
            x_label="",
            y_label="% Who Reject Different-Race Neighbor",
        ),
        ChartSpec(
